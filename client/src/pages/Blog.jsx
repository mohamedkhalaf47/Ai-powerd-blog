	...
	return data ? (
		<div className="relative">
			...
			<div className="mx-5 max-w-5xl md:mx-auto">
				<img src={data.image} alt="post" className="rounded-3xl mb-5" />
				<div
				...
				<div className="my-24 max-w-3xl mx-auto">
					...
					<div className="flex">
						<img src={assets.facebook_icon} alt="social media" width={50} />
						<img src={assets.twitter_icon} alt="social media" width={50} />
						<img src={assets.googleplus_icon} alt="social media" width={50} />
					</div>
				</div>
			</div>
			<Footer />
